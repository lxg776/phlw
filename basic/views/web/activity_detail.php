...
<div class="aui-content aui-margin-b-15" style="margin-top: 0.5rem;">
    <section class="aui-content-padded">
        <h1><?php echo $modle['title'] ?></h1>
        <div style="position: relative; height: 16px;font-size:14px;"  >
            <div style="position: absolute; left: 0px;">活动时间:<?php echo $modle['activity_time'] ?> </div>
            <div style="position: absolute; right: 2px;">主办方:<?php echo $modle['sponsor'] ?></div>
        </div>
        <div class="aui-content" style="padding-top: 16px;">
            <?php echo $modle['content'] ?>
        </div>
    </section>
